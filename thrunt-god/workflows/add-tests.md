...
Users currently hand-craft `/thrunt:quick` prompts for test generation after each phase. This workflow standardizes the process with proper classification, quality gates, and gap reporting.
</purpose>
...
Example: `/thrunt:add-tests 12 focus on edge cases` → `$PHASE_ARG=12`, `$EXTRA_INSTRUCTIONS="focus on edge cases"`

If no phase argument provided:

```
ERROR: Phase number required
Usage: /thrunt:add-tests <phase> [additional instructions]
Example: /thrunt:add-tests 12
Example: /thrunt:add-tests 12 focus on edge cases in the pricing module
```
...
3. `${phase_dir}/*-FINDINGS.md` — user-verified scenarios (if Evidence Review was done)

If no SUMMARY.md exists:
```
ERROR: No SUMMARY.md found for phase ${PHASE_ARG}
This command works on completed phases. Run /hunt:run first.
```
Exit.
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 THRUNT ► ADD TESTS — Phase ${phase_number}: ${phase_name}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
</step>
...
1. Identify user scenarios from CONTEXT.md/FINDINGS.md
...
2. **Create test file** targeting the user scenario from CONTEXT.md/FINDINGS.md
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 THRUNT ► TEST GENERATION COMPLETE
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```bash
node "$HOME/.claude/thrunt-god/bin/thrunt-tools.cjs" state-snapshot
```
...
{if bugs discovered:}
**Fix discovered bugs:** `/thrunt:quick fix the {N} test failures discovered in phase ${phase_number}`
...
**Also available:**
- `/thrunt:add-tests {next_phase}` — test another phase
- `/hunt:validate-findings {phase_number}` — run Evidence Review verification
...
<success_criteria>
- [ ] Phase artifacts loaded (SUMMARY.md, CONTEXT.md, optionally FINDINGS.md)
