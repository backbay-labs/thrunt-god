...
Called from hunt-plan.md's mandatory_discovery step with a depth parameter.

NOTE: For comprehensive ecosystem research ("how do experts build this"), use /hunt:shape-hypothesis instead, which produces RESEARCH.md.
</purpose>
...
**Depth is determined by hunt-plan.md before routing here.**
</depth_levels>
...
See ~/.claude/thrunt-god/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>

<process>

<step name="determine_depth">
Check the depth parameter passed from hunt-plan.md:
...
4. **If verified:** Return to hunt-plan.md with confirmation. No DISCOVERY.md needed.
...
6. **Create DISCOVERY.md** using ~/.claude/thrunt-god/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/thrunt-god/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/thrunt-god/templates/discovery.md
...
Use ~/.claude/thrunt-god/templates/discovery.md.
...
1. Discuss phase context (/hunt:shape-hypothesis [current-phase])
2. Create phase plan (/hunt:plan [current-phase])
