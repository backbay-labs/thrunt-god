...
4. **HUNTMAP.md** — milestone context and phase goals
...
Read `.planning/HUNTMAP.md` to get milestone name and goals.
...
**Generated:** [timestamp]
**Project:** [from MISSION.md title or directory name]
**Milestone:** [N] — [milestone name from HUNTMAP.md]
...
*Generated by `/thrunt:session-report`*
```
</step>
...
```
💡 Run `/thrunt:session-report` at the end of each session to build a history of project activity.
```
</step>
