...
```bash
node "$HOME/.claude/thrunt-god/bin/thrunt-tools.cjs" validate health $REPAIR_FLAG
```
...
- ✓ STATE.md: Regenerated from huntmap
```
...
- [E001] config.json: JSON parse error at line 5
  Fix: Run /thrunt:health --repair to reset to defaults

- [E002] MISSION.md not found
  Fix: Run /hunt:new-program to create
```
...
```
---
N issues can be auto-repaired. Run: /thrunt:health --repair
```
</step>
...
```
Would you like to run /thrunt:health --repair to fix N issues automatically?
```
...
```bash
node "$HOME/.claude/thrunt-god/bin/thrunt-tools.cjs" validate health
```
...
| E002 | error | MISSION.md not found | No |
| E003 | error | HUNTMAP.md not found | No |
| E004 | error | STATE.md not found | Yes |
| E005 | error | config.json parse error | Yes |
| W001 | warning | MISSION.md missing required section | No |
| W002 | warning | STATE.md references invalid phase | No |
| W003 | warning | config.json not found | Yes |
| W004 | warning | config.json invalid field value | No |
| W005 | warning | Phase directory naming mismatch | No |
| W006 | warning | Phase in HUNTMAP but no directory | No |
| W007 | warning | Phase on disk but not in HUNTMAP | No |
...
| regenerateState | Create STATE.md from HUNTMAP structure when it is missing | Loses session history |
| addNyquistKey | Add workflow.nyquist_validation: true to config.json | None — matches existing default |

**Not repairable (too risky):**
- MISSION.md, HUNTMAP.md content
