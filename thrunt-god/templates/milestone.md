...
**Delivered:** [One sentence describing what published]
...
- [D] days from start to publish (or milestone to milestone)
...
```markdown
# Program Milestones: [Project Name]
...
- Phase/plan/task counts from HUNTMAP
