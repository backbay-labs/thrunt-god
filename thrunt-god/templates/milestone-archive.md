...
- Decision: Use HUNTMAP.md split (Rationale: Constant context cost)
...
_For current project status, see .planning/HUNTMAP.md_
...
- Extract phase details from HUNTMAP.md
...
- Update HUNTMAP.md to collapse completed milestone in `<details>` tag
- Update MISSION.md to brownfield format with Current State section
