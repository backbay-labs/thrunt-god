...
**CRITICAL:** If CONTEXT.md exists from /hunt:shape-hypothesis, copy locked decisions here verbatim. These MUST be honored by the planner.
...
**Structure:**
- Use XML tags for section markers (matches THRUNT templates)
...
- hunt-plan loads it automatically when present
