...
│   └── thrunt/           # THRUNT-specific commands
├── thrunt-god/     # Skill resources
...
- Key files: hunt-bootstrap.md, hunt-plan.md, execute-plan.md
- Subdirectories: None (flat structure)

**thrunt-god/references/**
...
- Key files: execute-plan.md, hunt-plan.md
- Subdirectories: None
...
**New Slash Command:**
- Primary code: `commands/thrunt/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `thrunt-god/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `thrunt-god/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/thrunt-god/workflows/{name}.md`

**New Reference Document:**
- Implementation: `thrunt-god/references/{name}.md`
