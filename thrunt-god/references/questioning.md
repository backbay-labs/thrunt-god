...
By the end of questioning, you need enough clarity to write a MISSION.md that downstream phases can act on:

- **Research** needs: what domain to research, what the user already knows, what unknowns exist
- **Hypotheses** needs: clear enough vision to scope v1 features
- **Huntmap** needs: clear enough vision to decompose into phases, what "done" looks like
- **hunt-plan** needs: specific requirements to break into tasks, context for implementation choices
- **hunt-run** needs: success criteria to verify against, the "why" behind requirements

A vague MISSION.md forces every downstream phase to guess. The cost compounds.
...
When you could write a clear MISSION.md, offer to proceed:

- header: "Ready?"
- question: "I think I understand what you're after. Ready to create MISSION.md?"
- options:
  - "Create MISSION.md" — Let's move forward
  - "Keep exploring" — I want to share more / ask me more

If "Keep exploring" — ask what they want to add or identify gaps and probe naturally.

Loop until "Create MISSION.md" selected.
