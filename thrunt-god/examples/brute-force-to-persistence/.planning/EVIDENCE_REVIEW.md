# Evidence Review: Meridian Identity Abuse Program
...
- Open the child case if you want to inspect full query and receipt content from the underlying compromise investigation.
