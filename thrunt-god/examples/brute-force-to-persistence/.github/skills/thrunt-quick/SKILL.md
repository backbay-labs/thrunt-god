...
<objective>
Execute small, ad-hoc tasks with THRUNT guarantees (atomic commits, STATE.md tracking).
...
<execution_context>
@.github/thrunt-god/workflows/quick.md
</execution_context>
...
<process>
Execute the quick workflow from @.github/thrunt-god/workflows/quick.md end-to-end.
