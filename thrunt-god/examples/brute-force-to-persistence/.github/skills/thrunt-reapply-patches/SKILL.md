---
name: thrunt-reapply-patches
description: Reapply local modifications after a THRUNT update
---
...
1. **Read the backed-up version** (user's modified copy from `thrunt-local-patches/`)
