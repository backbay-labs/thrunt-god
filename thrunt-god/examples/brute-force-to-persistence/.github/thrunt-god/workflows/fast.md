...
Use /thrunt-quick for anything that needs multi-step planning or research.
</purpose>
...
```
This looks like it needs planning. Use /thrunt-quick instead:
  /thrunt-quick "{task description}"
```
...
- If the task takes more than 3 file edits, STOP and redirect to /thrunt-quick
- If you're unsure how to implement it, STOP and redirect to /thrunt-quick
</guardrails>
