...
See .github/thrunt-god/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using .github/thrunt-god/templates/discovery.md structure:
...
1. **Scope the discovery** using .github/thrunt-god/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from .github/thrunt-god/templates/discovery.md
...
Use .github/thrunt-god/templates/discovery.md.
