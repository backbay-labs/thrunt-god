...
```bash
node ".github/thrunt-god/bin/thrunt-tools.cjs" commit "docs: start milestone v[X.Y] [Name]" --files .planning/MISSION.md .planning/STATE.md
```

## 7. Load Context and Resolve Models

```bash
INIT=$(node ".github/thrunt-god/bin/thrunt-tools.cjs" init new-milestone)
if [[ "$INIT" == @file:* ]]; then INIT=$(cat "${INIT#@file:}"); fi
AGENT_SKILLS_RESEARCHER=$(node ".github/thrunt-god/bin/thrunt-tools.cjs" agent-skills thrunt-signal-triager 2>/dev/null)
AGENT_SKILLS_SYNTHESIZER=$(node ".github/thrunt-god/bin/thrunt-tools.cjs" agent-skills thrunt-synthesizer 2>/dev/null)
AGENT_SKILLS_HUNTMAPPER=$(node ".github/thrunt-god/bin/thrunt-tools.cjs" agent-skills thrunt-huntmap-builder 2>/dev/null)
```
...
Use template: .github/thrunt-god/templates/research-program/{FILE}
</output>
...
**Commit requirements:**
```bash
node ".github/thrunt-god/bin/thrunt-tools.cjs" commit "docs: define milestone v[X.Y] requirements" --files .planning/HYPOTHESES.md
```
...
```bash
node ".github/thrunt-god/bin/thrunt-tools.cjs" commit "docs: create milestone v[X.Y] huntmap ([N] phases)" --files .planning/HUNTMAP.md .planning/STATE.md .planning/HYPOTHESES.md
```
