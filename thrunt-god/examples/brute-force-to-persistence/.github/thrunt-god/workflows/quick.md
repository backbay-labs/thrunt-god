...
```bash
INIT=$(node ".github/thrunt-god/bin/thrunt-tools.cjs" init quick "$DESCRIPTION")
if [[ "$INIT" == @file:* ]]; then INIT=$(cat "${INIT#@file:}"); fi
AGENT_SKILLS_PLANNER=$(node ".github/thrunt-god/bin/thrunt-tools.cjs" agent-skills thrunt-hunt-planner 2>/dev/null)
AGENT_SKILLS_EXECUTOR=$(node ".github/thrunt-god/bin/thrunt-tools.cjs" agent-skills thrunt-telemetry-executor 2>/dev/null)
AGENT_SKILLS_CHECKER=$(node ".github/thrunt-god/bin/thrunt-tools.cjs" agent-skills thrunt-hunt-checker 2>/dev/null)
AGENT_SKILLS_VALIDATOR=$(node ".github/thrunt-god/bin/thrunt-tools.cjs" agent-skills thrunt-findings-validator 2>/dev/null)
```
...
```bash
node ".github/thrunt-god/bin/thrunt-tools.cjs" commit "docs(quick-${quick_id}): ${DESCRIPTION}" --files ${file_list}
```
