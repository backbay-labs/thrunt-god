...
```bash
INIT=$(node ".github/thrunt-god/bin/thrunt-tools.cjs" init manager)
...
Steps:
1. Read `commands/hunt/plan.md` and `.github/thrunt-god/workflows/hunt-plan.md`.
2. Run: node \".github/thrunt-god/bin/thrunt-tools.cjs\" init plan {N}
...
Steps:
1. Read `commands/hunt/run.md` and `.github/thrunt-god/workflows/hunt-run.md`.
2. Run: node \".github/thrunt-god/bin/thrunt-tools.cjs\" init run {N}
