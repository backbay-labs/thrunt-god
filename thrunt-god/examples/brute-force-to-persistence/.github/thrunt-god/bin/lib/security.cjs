 ...
 *
 * This module centralizes security checks for THRUNT tooling. Because THRUNT generates
...
const INJECTION_PATTERNS = [
  ...
  // Note: <instructions> is excluded — THRUNT uses it as legitimate prompt structure
