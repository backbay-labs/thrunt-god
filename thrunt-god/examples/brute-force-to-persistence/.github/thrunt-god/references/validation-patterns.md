...
- [ ] Relationpublishs defined if needed
...
For the validation subagent, use this pattern:
...
Run these checks against each must-have artifact. Aggregate results into FINDINGS.md.

</automated_verification_script>

<human_verification_triggers>

## When to Require Human Validation
...
**@.github/thrunt-god/references/checkpoints.md** → `<automation_reference>` section
