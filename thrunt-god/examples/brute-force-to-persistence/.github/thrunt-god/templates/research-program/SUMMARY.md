...
Template for `.planning/research/SUMMARY.md` — executive summary of project research with huntmap implications.
...
- Focus on what matters for huntmap decisions

**Implications for Huntmap:**
- This is the most important section
- Directly informs huntmap creation
...
**Integration with huntmap creation:**
- This file is loaded as context during huntmap creation
- Phase suggestions here become starting point for huntmap
