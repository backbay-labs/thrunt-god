...
Template for `.planning/phases/XX-name/{phase_num}-DISCUSSION-LOG.md` — audit trail of shape-hypothesis Q&A sessions.
...
- Generated automatically at end of every shape-hypothesis session
