...
1. User runs: `thrunt new-program`
2. Commander parses args and flags
3. Command handler invoked (`src/commands/new-program.ts`)
...
- Examples: `src/commands/new-program.ts`, `src/commands/hunt-plan.ts`
- Pattern: Commander.js command registration

**Template:**
- Purpose: Reusable document structures
- Examples: MISSION.md, PLAN.md templates
...
- Triggers: User runs `thrunt <command>`
