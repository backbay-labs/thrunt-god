...
**Purpose:** Answer "which library/option should we use" questions during mandatory discovery in hunt-plan.

For deep ecosystem research ("how do experts build this"), use `/hunt-shape-hypothesis` which produces RESEARCH.md.
...
- Use `/hunt-shape-hypothesis` for these
</guidelines>
