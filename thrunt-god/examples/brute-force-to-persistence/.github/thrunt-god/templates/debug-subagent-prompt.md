...
Template for spawning thrunt-incident-debugger agent. The agent contains all debugging expertise - this template provides problem context only.
...
```python
Task(prompt=template, subagent_type="thrunt-incident-debugger", description="Debug UAT-001")
```
