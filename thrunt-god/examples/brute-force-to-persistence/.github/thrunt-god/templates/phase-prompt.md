...
<execution_context>
@.github/thrunt-god/workflows/execute-plan.md
@.github/thrunt-god/templates/summary.md
[If plan contains checkpoint tasks (type="checkpoint:*"), add:]
@.github/thrunt-god/references/checkpoints.md
</execution_context>
...
<!-- For checkpoint task examples and patterns, see @.github/thrunt-god/references/checkpoints.md -->
...
See `.github/thrunt-god/references/tdd.md` for TDD plan structure.
...
See `.github/thrunt-god/templates/user-setup.md` for full schema and examples
...
See `.github/thrunt-god/workflows/findings-validation.md` for validation logic.
