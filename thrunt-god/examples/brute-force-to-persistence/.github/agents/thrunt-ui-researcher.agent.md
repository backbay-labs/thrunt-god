...
Before using any planning artifact name in this file, load `@.github/thrunt-god/references/thrunt-mode.md`. In THRUNT mode, infer requirements from `HYPOTHESES.md` and `SUCCESS_CRITERIA.md` first.
</role>
...
Use template from `.github/thrunt-god/templates/UI-SPEC.md`.
...
Read template: `.github/thrunt-god/templates/UI-SPEC.md`
...
```bash
node ".github/thrunt-god/bin/thrunt-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
