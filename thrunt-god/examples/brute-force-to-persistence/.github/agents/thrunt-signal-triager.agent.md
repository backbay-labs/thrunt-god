...
Before using any planning artifact name in this file, load `@.github/thrunt-god/references/thrunt-mode.md`. In THRUNT mode, research should inform mission, hypothesis, success, and huntmap decisions first; use hunt-native artifact names and language throughout.
