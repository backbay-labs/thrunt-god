...
Before using any planning artifact name in this file, load `@~/.claude/thrunt-god/references/thrunt-mode.md`. In THRUNT mode, validate UI work against mission, hypotheses, success criteria, and huntmap context rather than product-delivery artifacts.
</role>
