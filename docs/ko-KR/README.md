...
THRUNT GOD (THRUNT) 프레임워크의 종합 문서입니다. THRUNT는 AI 코딩 에이전트를 위한 메타 프롬프팅, 컨텍스트 엔지니어링, 스펙 기반 개발 시스템입니다.
...
| [CLI Tools Reference](CLI-TOOLS.md) | 기여자, 에이전트 작성자 | 워크플로우 및 에이전트를 위한 `thrunt-tools.cjs` 프로그래매틱 API |
...
- **시작하기:** [README](../README.md) → 설치 → `/hunt:new-program`
- **전체 워크플로우 안내:** [User Guide](USER-GUIDE.md)
- **모든 명령어 한눈에 보기:** [Command Reference](COMMANDS.md)
- **THRUNT 설정하기:** [Configuration Reference](CONFIGURATION.md)
