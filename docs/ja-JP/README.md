...
THRUNT GOD（THRUNT）フレームワークの包括的なドキュメントです。THRUNT は、AI コーディングエージェント向けのメタプロンプティング、コンテキストエンジニアリング、仕様駆動開発システムです。
...
| [CLI ツールリファレンス](CLI-TOOLS.md) | コントリビューター、エージェント作成者 | `thrunt-tools.cjs` のプログラマティック API（ワークフローおよびエージェント向け） |
...
- **はじめに:** [README](../README.md) → インストール → `/hunt:new-program`
- **ワークフロー完全ガイド:** [ユーザーガイド](USER-GUIDE.md)
- **コマンド一覧:** [コマンドリファレンス](COMMANDS.md)
- **THRUNT の設定:** [設定リファレンス](CONFIGURATION.md)
