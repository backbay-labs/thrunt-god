...
到提问结束时，你需要足够的清晰度来编写下游阶段可执行的 MISSION.md：

- **研究** 需要：研究什么领域、用户已知什么、存在哪些未知
- **需求** 需要：足够清晰的愿景来界定 v1 功能
- **路线图** 需要：足够清晰的愿景来分解为阶段、"完成"是什么样子
- **hunt-plan** 需要：可分解为任务的具体需求、实现选择的上下文
- **hunt-run** 需要：可验证的成功标准、需求背后的"为什么"

模糊的 MISSION.md 会让每个下游阶段都在猜测。成本会叠加。
...
当你能写出清晰的 MISSION.md 时，提议继续：

- header: "准备好了？"
- question: "我想我理解你想要什么了。准备创建 MISSION.md 吗？"
- options:
  - "创建 MISSION.md" — 让我们继续
  - "继续探索" — 我想分享更多 / 再问我
