# THRUNT Documentation

Comprehensive documentation for the THRUNT GOD (THRUNT) framework — a meta-prompting, context engineering, and spec-driven development system for AI coding agents.
...
| [CLI Tools Reference](CLI-TOOLS.md) | Contributors, agent authors | `thrunt-tools.cjs` programmatic API for workflows and agents |
...
| [Discuss Mode](workflow-discuss-mode.md) | All users | Assumptions vs interview mode for shape-hypothesis |

## Quick Links

- **What's new in v1.28:** Forensics, milestone summary, workstreams, assumptions mode, UI auto-detect, manager dashboard
- **Getting started:** [README](../README.md) → install → `/hunt:new-program`
- **Full workflow walkthrough:** [User Guide](USER-GUIDE.md)
- **All commands at a glance:** [Command Reference](COMMANDS.md)
- **Configuring THRUNT:** [Configuration Reference](CONFIGURATION.md)
