# Plano: Materializar Configuração no `new-program` (pt-BR)

Data original: 2026-03-23  
Fonte canônica: `docs/superpowers/plans/2026-03-18-materialize-new-program-config.md`

---

## Contexto

Este plano formaliza a materialização explícita da configuração do projeto durante `/hunt:new-program`, garantindo que escolhas feitas na inicialização sejam persistidas de forma determinística em `.planning/config.json`.
...
- após `/hunt:new-program`, `config.json` reflete as escolhas feitas
