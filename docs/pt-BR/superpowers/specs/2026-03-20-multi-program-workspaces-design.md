...
Fonte canônica: `docs/superpowers/specs/2026-03-20-multi-program-workspaces-design.md`
...
- **Workspace**: unidade isolada de execução THRUNT
...
2. Inicializar/retomar fluxo THRUNT dentro do workspace
