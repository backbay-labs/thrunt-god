...
- [ ] 65-02-PLAN.md — Detect macOS vaults, create/update symlinked plugin directories, and surface clear install output
...
| 65. Obsidian CLI Install Channel | v3.3 | 1/3 | In Progress | - |
