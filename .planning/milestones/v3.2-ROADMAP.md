...
- [x] **Phase 64: Live Hunt Dashboard** - STATE.md/HYPOTHESES.md parsing, hunt status card, live status bar, frontmatter templates with wiki-links (completed 2026-04-11)
