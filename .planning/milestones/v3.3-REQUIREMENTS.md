# Requirements Archive: v3.3 Zero-Friction Distribution

**Archived:** 2026-04-11
**Status:** SHIPPED

This file preserves the shipped v3.3 requirements set. A new root `.planning/REQUIREMENTS.md` is created when the next milestone starts.
...
*Last updated: 2026-04-11 after milestone completion*
