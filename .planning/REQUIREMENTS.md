...
- [ ] **ADPT-01**: Elastic/Kibana adapter extracts KQL queries, result tables, and entities from Kibana Discover, Dashboard, and Security pages with real DOM selectors
- [ ] **ADPT-02**: CrowdStrike Falcon adapter extracts FQL queries, detection details, and endpoint entities from Falcon console pages with real DOM selectors
- [ ] **ADPT-03**: Elastic and CrowdStrike adapters have fixture-backed Playwright tests validating extraction against saved HTML snapshots
