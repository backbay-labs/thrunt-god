...
<execution_context>
@~/.claude/thrunt-god/workflows/hunt-validate-findings.md
@~/.claude/thrunt-god/templates/findings.md
@~/.claude/thrunt-god/templates/evidence-review.md
</execution_context>

<process>
Execute the validation workflow from @~/.claude/thrunt-god/workflows/hunt-validate-findings.md.
