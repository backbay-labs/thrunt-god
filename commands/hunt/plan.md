...
<execution_context>
@~/.claude/thrunt-god/workflows/hunt-plan.md
@~/.claude/thrunt-god/templates/context.md
@~/.claude/thrunt-god/templates/phase-prompt.md
</execution_context>

<process>
Execute the hunt planning workflow from @~/.claude/thrunt-god/workflows/hunt-plan.md.
