...
<execution_context>
@~/.claude/thrunt-god/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @~/.claude/thrunt-god/workflows/session-report.md end-to-end.
</process>
