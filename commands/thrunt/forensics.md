...
<objective>
Investigate what went wrong during a THRUNT workflow execution. Analyzes git history, `.planning/` artifacts, and file system state to detect anomalies and generate a structured diagnostic report.
...
<execution_context>
@~/.claude/thrunt-god/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @~/.claude/thrunt-god/workflows/forensics.md end-to-end.
</process>
